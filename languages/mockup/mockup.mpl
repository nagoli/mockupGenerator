...
<language namespace="mockup" uuid="d31426f0-4a34-47ca-841c-d0be6c42e313">
  <models>
  ...
  <accessoryModels />
  <generators>
    <generator name="" generatorUID="mockup#6484469149691179258" uuid="aa852db2-5f1e-46b4-9001-7137d17b5b3d">
      <models>
        <modelRoot contentPath="${module}" type="default">
      ...
      <external-templates />
      <dependencies>
        <dependency reexport="false">d31426f0-4a34-47ca-841c-d0be6c42e313(mockup)</dependency>
      </dependencies>
      <usedLanguages>
