...
<model modelUID="r:b5739d9b-a2e1-4c05-a8e6-bee7ff27eac2(mockup.generator.template.main@generator)">
  ...
  <root type="tpf8.TemplateDeclaration" typeId="tpf8.1092059087312" id="6484469149691729158" nodeInfo="ng">
    ...
    <node role="contentNode" roleId="tpf8.1092060348987" type="mkop.Pattern" typeId="mkop.6484469149691220291" id="6035835504269672793" nodeInfo="ng">
      ...
      <node role="smodelAttribute" roleId="tpck.5169995583184591170" type="tpf8.InsertMacro" typeId="tpf8.1311078761699563726" id="6035835504269672813" nodeInfo="nn">
        <node role="createNodeQuery" roleId="tpf8.1311078761699602381" type="tpf8.InsertMacro_CreateNodeQuery" typeId="tpf8.1311078761699563727" id="6035835504269672815" nodeInfo="nn">
          <node role="body" roleId="tpee.1137022507850" type="tpee.StatementList" typeId="tpee.1068580123136" id="6035835504269672817" nodeInfo="sn">
            <node role="statement" roleId="tpee.1068581517665" type="tpee.ExpressionStatement" typeId="tpee.1068580123155" id="6035835504269672906" nodeInfo="nn">
              <node role="expression" roleId="tpee.1068580123156" type="tpee.DotExpression" typeId="tpee.1197027756228" id="6035835504270150174" nodeInfo="nn">
                <node role="operand" roleId="tpee.1197027771414" type="tpf8.TemplateFunctionParameter_sourceNode" typeId="tpf8.1167169188348" id="6035835504269672905" nodeInfo="nn" />
                <node role="operation" roleId="tpee.1197027833540" type="tp25.Node_ConceptMethodCall" typeId="tp25.1179409122411" id="6035835504270151407" nodeInfo="nn">
                  <link role="baseMethodDeclaration" roleId="tpee.1068499141037" targetNodeId="m93c.6035835504270072636" resolveInfo="evaluate" />
                </node>
              </node>
            </node>
          </node>
